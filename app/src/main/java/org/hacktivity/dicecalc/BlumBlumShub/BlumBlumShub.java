...
package org.hacktivity.dicecalc.BlumBlumShub;
...
public class BlumBlumShub {
    ...
    public ArrayList randIntArray(int base, int nmemb) {
        int i;
    ...
    public int randInt(int base) {
        int i;
        Integer rndint = 0;

	/* we waste a few precious bits here unless we're a power of 256 */
        Double nbytes =
                new Double(Math.ceil(1 *
                        (Math.log(base) / Math.log(256.0))));
